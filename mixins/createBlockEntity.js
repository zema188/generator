...
export default function useCreateBlockEntity() {
    ...
    const titleTags = ref([{name: 'h1',value: 'Заголовок 1-го уровня'},{name: 'h2',value: 'Заголовок 2-го уровня'},{name: 'h3',value: 'Заголовок 3-го уровня'},{name: 'h4',value: 'Заголовок 4-го уровня'},{name: 'h5',value: 'Заголовок 5-го уровня'},{name: 'h6',value: 'Заголовок 6-го уровня'},])
    ...
    return {
        paramsNewBlock, textAlign, color, fontWeight, listStyle, titleTags, createClass
    }
}